...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Varietal.slug'
        db.add_column('wineries_varietal', 'slug', self.gf('django.db.models.fields.SlugField')(default='changeme', max_length=50, db_index=True), keep_default=False)

        # Adding field 'Varietal.color'
        db.add_column('wineries_varietal', 'color', self.gf('django.db.models.fields.CharField')(default='changeme', max_length=100), keep_default=False)

        # Adding field 'Winery.slug'
        db.add_column('wineries_winery', 'slug', self.gf('django.db.models.fields.SlugField')(default='changeme', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Varietal.slug'
        db.delete_column('wineries_varietal', 'slug')

        # Deleting field 'Varietal.color'
        db.delete_column('wineries_varietal', 'color')

        # Deleting field 'Winery.slug'
        db.delete_column('wineries_winery', 'slug')
